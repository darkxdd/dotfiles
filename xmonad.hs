...
myTerminal :: String
myTerminal = "LIBGL_ALWAYS_SOFTWARE=1 kitty"    -- Sets default terminal

myBrowser :: String
myBrowser = "firefox-trunk"  -- Sets qutebrowser as browser
...
myStartupHook = do
    ...
    setWMName "xmonad"
    spawnOnce "xsetroot -cursor_name left_ptr &"   -- cursor icon
...
myManageHook = composeAll
     ...
     , title =? "Firefox Nightly"     --> doShift ( myWorkspaces !! 1 )
     , className =? "Brave-browser"   --> doShift ( myWorkspaces !! 1 )
     , className =? "mpv"             --> doShift ( myWorkspaces !! 7 )
     , className =? "Gimp"            --> doShift ( myWorkspaces !! 8 )
     , className =? "VirtualBox Manager" --> doShift  ( myWorkspaces !! 4 )
     , (className =? "firefox-trunk" <&&> resource =? "Dialog") --> doFloat  -- Float firefox-trunk Dialog
    ...
    xmonad $ ewmh def
        ...
        , logHook = dynamicLogWithPP $ namedScratchpadFilterOutWorkspacePP $ xmobarPP
              ...
              { ppOutput = \x -> hPutStrLn xmproc0 x   -- xmobar on monitor 1
                -- Current workspace
              , ppCurrent = xmobarColor color06 "" . clickable
